...
#         self.add_pool_dialog.show()
    ...
    def add_edit_pool(self, pool_id, pool_display_name, pool_url, pool_username, pool_password, pool_algo, pool_ssl):
        ...
        if pool_id == "":
            ...
            self.on_create_note_pool_list_event.emit(json.dumps([_pool_info]), CPU_COUNT, sys.platform == "win32")
            self.add_pool_dialog.close()
...
#                 self.on_stop_mining_event.emit(pool_info["id"]) 
    ...
    def create_pool_list(self):
        ...
        self.on_create_note_pool_list_event.emit(json.dumps(pool_list), CPU_COUNT, sys.platform == "win32")
    ...
    on_create_note_pool_list_event = Signal(str, int, bool)
