    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function app_ready(){
                ...
                app_hub.on_create_note_pool_list_event.connect(create_pool_list);
        ...
        <style type="text/css">
            * {
            ...
            .cryptonote-org-link a{
                color: #ffd633;
                cursor: pointer;
            }
            
            .cryptonote-org-link a:hover{
                color: #fff;
                ...
                <thead>
                    <tr style="height:50px;background: -webkit-linear-gradient(top, #7abcff 0%,#60abf8 30%,#4096ee 100%);">
                        <th colspan="5" style="" class="banner"> 
                            <p class="cryptonote-org-link">v0.1 (Beta 1.3) by <a href="#" onclick="open_link('https://nur1labs.net')">nur1labs.net</a></p>                 
                        </th>
